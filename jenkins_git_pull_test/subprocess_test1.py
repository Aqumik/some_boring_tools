...
if __name__ == '__main__':
    ...
    # try:
    sys_env = Os_env()
    git = Git_module(push_root_dir, file_name, jenkins_output_path, repo_url, local_branch_name, commit_content,repo_name, remote_branch_name)
    ...
    # git.change_work_path()
    # git.git_init_action()
    #实例化Repo
    git.test1()
    # git.checkout_branch()
    # git.hash()
    # git.pull_action_module()
    # git.delete_module()
    # git.jenkins_to_push_dir()
    # git.pull_action_module()
